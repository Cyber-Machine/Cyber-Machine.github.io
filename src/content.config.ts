...
const remoteImageSchema = z
  ...
  .refine(
    ...
    "Remote images must start with http:// or https://",
  );

const contentImageSchema = ({
  image,
}: Parameters<CollectionSchemaFactory>[0]) =>
...
const commentProviderSchema = z.enum([
  "giscus",
  "utterances",
  "waline",
  "none",
...
const siteConfig = defineCollection({
  ...
  schema: z.object({
    ...
    code: z
      .object({
        ...
        lineNumbers: z
          .boolean()
          .optional()
          .default(defaultCodeConfig.lineNumbers),
        wrap: z.boolean().optional().default(defaultCodeConfig.wrap),
        preserveIndent: z
          .boolean()
          .optional()
          .default(defaultCodeConfig.preserveIndent),
        collapseStyle: collapseStyleSchema
          .optional()
          .default(defaultCodeConfig.collapseStyle),
      })
      .optional()
    ...
    home: z.object({
      ...
      latest: z
        .object({
          source: z.enum(["blog", "github"]).optional().default("github"),
...
const vibe = defineCollection({
  ...
  schema: ({ image }) =>
    z.object({
      ...
      draft: z.boolean().optional().default(false),
      type: z
        .enum(["text", "photo", "quote", "code", "mixed"])
        .optional()
        .default("text"),
